       ...
       //Pending members
        ...
        //---------------------------------------------New december --------------------------------
         public function saveNewMember($data) {
            ...
            //---------------------------------------------New 29.7.24 --------------------------------
            public function insert_consultation1($data) {
                return $this->db->insert('consultations_1', $data);
            }
            
            public function insert_consultation2($data) {
                return $this->db->insert('consultations_2', $data);
            }
            
            public function delete_consultations_1_by_medical_history_id($medical_history_id) {
                $this->db->where('medical_history_id', $medical_history_id);
                return $this->db->delete('consultations_1');
            }
            
            public function delete_consultations_2_by_medical_history_id($medical_history_id) {
                $this->db->where('medical_history_id', $medical_history_id);
                return $this->db->delete('consultations_2');
            }

            public function get_consultations_1($medical_history_id, $member_id) {
                $this->db->where('medical_history_id', $medical_history_id);
                $this->db->where('member_id', $member_id);
                return $this->db->get('consultations_1')->result();
            }
            public function get_consultations_2($medical_history_id, $member_id) {
                $this->db->where('medical_history_id', $medical_history_id);
                $this->db->where('member_id', $member_id);
                return $this->db->get('consultations_2')->result();
            }
