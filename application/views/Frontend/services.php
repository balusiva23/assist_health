        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/post_hospital.jpg" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
                ...
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/health_records.png" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
            ...
            <div class="row pt-30">
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/health_care.jpg" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
                ...
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/education.png" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
                ...
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/24-care.png" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
                ...
                <div class="col-md-4">
                    <div class="single-blog-post">
                        <div class="img-box">
                            <img src="<?php echo base_url(); ?>assets/web_assets/img/services/hospital_companion.png" alt="">
                            <div class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <ul>
                                            <li><a href="<?php echo base_url(); ?>HospitalCompanion"><i class="fa fa-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="content-box">
                            ...
                            <div class="content">
                                <a href="<?php echo base_url(); ?>HospitalCompanion">
                                    <h3>AH Hospital Companion
                                    </h3>
                                </a>
                                <p>At AssistHealth, Transform your healthcare visits with AH Hospital Companion.</p>
                                <a href="<?php echo base_url(); ?>HospitalCompanion" class="thm-btn">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
