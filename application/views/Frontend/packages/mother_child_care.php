        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 sec-title colored text-center">
                    <h2>Mother & Child Package</h2>
                    <ul class="breadcumb">
                        <li><a href="<?php echo base_url(); ?>">Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><span>Mother & Child Package</span></li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 single-blog-post">
                <div class="img-box">
                    <img src="<?php echo base_url(); ?>assets/web_assets/img/blog/4.jpg" alt="">
                    <div class="overlay">
                        <div class="box">
                            <div class="content">
                                <ul>
            ...
            <div class="col-md-6 single-team-member">
                <h3>Mother & Child Package</h3>
                <p>&#10004; For Mother: Postpartum Care Coordination</p>
                <p>&#10004; Nutrition, Lifestyle Guidance and Education</p>
                <p>&#10004; Mental Health and Emotional Support</p>
                <p>&#10004; Discounts at our associated Healthcare Providers</p>
                <p>&#10004; Home Care Service </p>
                <p>&#10004; Medical Transportation </p>
                <!-- <p>&#10004; High-Risk Pregnancy Support </p> -->
                <p>&#10004; Mental Health and Emotional Support</p>
                <p>&#10004; For Child: Pediatric Care</p>
                <p>&#10004; Early Intervention Services </p>
                <p>&#10004; Post-Delivery Care</p>
                <p>&#10004; Hospital Companion Service </p>
                <p>&#10004; 15,000 rs / 18 Months</p>
