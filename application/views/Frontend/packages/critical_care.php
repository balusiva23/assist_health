        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 sec-title colored text-center">
                    <h2>Critical care package</h2>
                    <ul class="breadcumb">
                        <li><a href="<?php echo base_url(); ?>">Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><span>Critical care package</span></li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 single-blog-post">
                <div class="img-box">
                    <img src="<?php echo base_url(); ?>assets/web_assets/img/blog/7.jpg" alt="">
                    <div class="overlay">
                        <div class="box">
                            <div class="content">
                                <ul>
            ...
            <div class="col-md-6 single-team-member">
                <h3>Critical care package</h3>
                <p>&#10004; Healthcare Navigation: Dedicated Navigator / Doctor assigned to each member</p>
                <p>&#10004; Education and Information</p>
                <p>&#10004; Physical Support</p>
