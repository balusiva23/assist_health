        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 sec-title colored text-center">
                    <h2>Surgery care package</h2>
                    <ul class="breadcumb">
                        <li><a href="<?php echo base_url(); ?>">Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><span>Surgery care package</span></li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 single-blog-post">
                <div class="img-box">
                    <img src="<?php echo base_url(); ?>assets/web_assets/img/blog/6.jpg" alt="">
                    <div class="overlay">
                        <div class="box">
                            <div class="content">
                                <ul>
            ...
            <div class="col-md-6 single-team-member">
                <h3>Surgery care package</h3>
                <p>&#10004; Pre-Surgery Preparation: Specialist Surgeon Referrals</p>
                <p>&#10004; Insurance Coordination</p>
                <p>&#10004; Medical Transportation </p>
                <p>&#10004; Hospital Companion Service</p>
                <p>&#10004; Post Hospitalisation Care Home Care Service </p>
