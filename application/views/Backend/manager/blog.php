 ...
 // smallModel
    ...
    //     })
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getBlog_codeByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
    ...
    var formData = new FormData();
         ...
         $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/add_Blog");?>',//update_Blog
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Navigator/delete_Blog') ?>',
    data: {id:id},
    success: function (response) {
    ...
    $('.mymce').each(function() {
        ...
        contentArray.push(content);
           ...
           formData.append('content', JSON.stringify(contentArray));
            ...
            $.ajax({
            type:'post',
            url: '<?php echo base_url("Navigator/add_Blog");?>',
