...
<div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="tab-pane active fontawesome-demo" id="tab1">
                                        <div id="biography">
                                            <div class="row">
                                               ...
                                               <div class="row">
                                              <!--   <div class="col-md-3 col-xs-6 b-r"> <strong>Address
                                                        </strong>
                                                    <br>
                                                    <p class="text-muted"><?= substr($user_data->address, 0, 150);  ?> </p>
                                                </div> -->
                ...
                <!-- END PROFILE CONTENT -->
                                    ...
                                    <!--     
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="physician_no" name="physician_no" 
                                                placeholder="Number" value="<?= isset($medical_history->physician_no) ? $medical_history->physician_no : ''  ?>  " >
                                        </div>
                                    </div> -->
                                            <div class="col-md-6 col-sm-3">
                                              <label for="simpleFormPassword">Contact Number </label><span class="error"> </span>
                    ...
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Treating Doctors :</header>
                            <button type="button" name="add" id="add_cons_1" class="btn btn-success add-btn">+</button>
                        </div>
                        <div class="card-body " id="bar-parent0_1">
                        <?php if($consultations_1) { 
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Treating Doctor</label>
                                        <input type="text" class="form-control" name="treating_doctor[]" placeholder="Enter Doctor's Name" value="<?= $cons_1->treating_doctor ?>">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Hospital</label>
                                        <input type="text" class="form-control" name="hospital[]" placeholder="Enter Hospital Name" value="<?= $cons_1->hospital ?>">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Speciality</label>
                                        <input type="text" class="form-control" name="speciality[]" placeholder="Enter Speciality" value="<?= $cons_1->speciality ?>">
                                    </div>
                                </div>
                                <!-- <div class="col-md-3 col-sm-3">
                                    <div class="form-group">
                                        <label for="simpleFormPassword">Treatment Date</label>
                                        <input type="date" class="form-control" name="treatment_date[]" placeholder="Enter Treatment Date" value="<?= ($cons_1->treatment_date) ? date('Y-m-d', strtotime($cons_1->treatment_date)) : '' ?>">
                                    </div>
                                </div> -->
                              
                                <div class="col-md-1 col-sm-1 mt-4">
                                    <button type="button" name="remove" id="previous-<?= $previousCount ?>" data-id="<?= $cons_1->id ?>" data-table="<?php echo base64_encode('consultations_1') ?>" class="btn btn-danger DelBtn">X</button>
                                </div>
                            </div>
                            <?php 
                              $previousCount++;
                    ...
                    <div class="card card-box">
                        <div class="card-head">
                            ...
                            <button type="button" name="add" id="add_cons_2" class="btn btn-success add-btn">+</button>
                        </div>
                        <div class="card-body " id="bar-parent0_2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="treatment_date[]" placeholder="Enter  Date" value="<?= ($cons_2->treatment_date) ? date('Y-m-d', strtotime($cons_2->treatment_date)) : '' ?>">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Specialist Details</label>
                                        <input type="text" class="form-control" name="specialist_details[]" placeholder="Enter Specialist Details" value="<?= $cons_2->specialist_details ?>">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group">
                                        <label for="simpleFormPassword">Remarks</label>
                                        <input type="text" class="form-control" name="remarks[]" placeholder="Enter Remarks" value="<?= $cons_2->remarks ?>">
                                    </div>
                                </div>
                                <!-- <div class="col-md-2 col-sm-2">
                                    <div class="form-group">
                                        <label for="simpleFormPassword">Advised</label>
                                        <input type="text" class="form-control" name="advised[]" placeholder="Enter Advice" value="<?= $cons_2->advised ?>">
                                    </div>
                                </div> -->
                                <div class="col-md-1 col-sm-1 mt-4">
                                    <button type="button" name="remove" id="previous-<?= $previousCount ?>" data-id="<?= $cons_2->id ?>" data-table="<?php echo base64_encode('consultations_2') ?>" class="btn btn-danger DelBtn">X</button>
                                </div>
                            </div>
                            ...
                            <div class="card card-box">
                              ...
                              <!--       <div class="row">
                                    ...
                                    <input type="hidden" name="member_id" value="<?=$this->input->get('id');?>">
                                        ...
                                        <a type="button" href="<?php echo base_url()?>Navigator/Member_Medical_history" class="btn btn-default">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
   ...
   <?php $this->load->view('Backend/manager/manager-temp/footer'); ?> 
    ...
    <script src="<?php echo base_url(); ?>assets/backend_assets/data/date-time.init.js"></script>
       <?php $this->load->view('Backend/manager/manager-temp/add-more-fields'); ?> 
</body>
...
<script type="text/javascript">
   ...
   $(document).on('click','#add_medical',function(){
       ...
       //{
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/save_medical_history");?>',
        ...
        setTimeout(function(){
        window.location.href = '<?php echo base_url()?>Navigator/Member_Medical_history';
        },2000);
       ...
       $.confirm({
        ...
        $.ajax({
        type: 'post',
        url: '<?php echo base_url('Navigator/delete_items') ?>',
