                                                    ...
                                                    <div id="biography">
                                                      ...
                                                      <!--   <?php 
                                                        ...
                                                        // $doctor = $this->Doctor_model->getDoctorByID($d_id ); ?> -->
                                                         <?php 
                                                        if($user_data->isSubprofile){
                                                           $p_id = $user_data->parent_member;
                                                           $parent_member = $this->Manager_model->getMemberByID($p_id); 
                                                            $d_id = $parent_member->doctor;
                                                           $doctor = $this->Doctor_model->getDoctorByID($d_id); 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 col-xs-6 b-r"> Doctor Name
                                                                ...
                                                                <br>
                                                                <p class=""><?= ($doctor->name)? $doctor->name : 'Null'  ?> </p>
                                                            </div>
                                                            <div class="col-md-3 col-xs-6 b-r"> Doctor Number
                                                                <br>
                                                                <p class=""><?= ($doctor->mobile_no)? $doctor->mobile_no : 'Null' ?> </p>
                                                            </div>
                            ...
                            <div class="card card-box">
                                <div class="card-head  ">
                                         ...
                                         <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox1" value="9">
                                      </div>
                                                ...
                                                <table class="table table-striped table-hover dt-bootstrap5">
                                                    ...
                                                    <?php if($consultations_1) { 
                                                                        ...
                                                                        ?> 
                                                                            <tr>
                                                                                <td> <?=$previousCount?> </td>
                                                                                <td> <?= $cons_1->treating_doctor ?> </td>
                                                                                <td> <?= $cons_1->hospital ?> </td>
                                                                                <td> <?= $cons_1->speciality ?> </td>
                         ...
                         <div class="col-md-6 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                   ...
                                   <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox2" value="10">
                                      </div>
                                </div>
                                           ...
                                           <div class="">
                                                <table class="table table-striped table-hover dt-bootstrap5">
                                                    ...
                                                    <?php if($consultations_2) { 
                                                            ...
                                                            ?>              <tr>
                                                                            <td> <?=$previousCount?> </td>
                                                                            <td> <?= ($cons_2->treatment_date) ?  date('d-m-Y', strtotime($cons_2->treatment_date)) : ''?> </td>
                                                                            <td> <?= $cons_2->specialist_details ?> </td>
                                                                            <td> <?= $cons_2->remarks ?> </td>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head  ">
                                         ...
                                         <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox1" value="1">
                                      </div>
                         ...
                         <div class="col-md-6 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                   ...
                                   <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox2" value="2">
                                      </div>
                                </div>
                                <div class="card-body " id="bar-parent2">
                            ...
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Allergies</header>
                                     <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox3" value="3">
                                      </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                                ...
                                <div class="card-head">
                                    <header>Current Medications</header>
                                     <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox4" value="4">
                                      </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                                ...
                                <div class="card-head">
                                    <header>Family Medical History</header>
                                     <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox5" value="5">
                                      </div>
                          ...
                          <div class="col-md-6 col-sm-6">
                                ...
                                <div class="card-head">
                                    <header>Immunization History</header>
                                         <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox6" value="6">
                                      </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                                ...
                                <div class="card-head">
                                    <header>Previous Medical Test Results</header>
                                         <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox7" value="7">
                                      </div>
                ...
                <div class="col-md-6 col-sm-6">
                                ...
                                <div class="card-head">
                                    <header>Current Symptoms or Concerns</header>
                                       <div style="float:right;margin-right:5px ;">
                                          <input type="checkbox" class="pdf-checkbox  " id="pdf-checkbox8" value="8">
                                      </div>
                                </div>
                       ...
                       <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent5">
                                   <!-- <a href="<?php echo base_url("Admin/generate_pdf?id=").$member_id; ?>"  class="btn btn-primary" id="add_medical1" target="_blank">Generate PDF</a> -->
...
<script type="text/javascript">
   ...
   $(document).on('click','#add_medical',function(){
    ...
    $('#generate-pdf').click(function() {
        var selectedCheckboxes = $('.pdf-checkbox:checked')
            .map(function() {
                return $(this).val();
            })
            .get();
        ...
        if (selectedCheckboxes.length === 0) {
            alert("Please select at least one checkbox before generating the PDF.");
            return;
        }
            
        var member_id = <?php echo json_encode($member_id); ?>;
        var checkboxes = selectedCheckboxes.join(',');

        var pdfUrl = '<?php echo base_url("Navigator/generate_pdf"); ?>?id=' + member_id + '&checkboxes=' + checkboxes;
