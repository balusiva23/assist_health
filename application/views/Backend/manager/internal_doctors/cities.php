                        ...
                        <div class="col-md-12">
                          <div class="d-flex justify-content-end">
                                  <a type="button" data-bs-toggle="modal" data-bs-target="#smallModel" 
                                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary text-right"  style="text-transform: capitalize;">Add City
								</a>
                           </div>
                                                ...
                                                <?php
                                                 ...
                                                 if (!empty($cities)) {
                                                    ...
                                                    foreach ($cities as $city) { ?>
                                                        <tr class="odd gradeX" data-id="<?=$city->id;?>">
                                                            
                                                            <td class="center"><?php echo $count; ?></td>
                                                            <td class="center"><?php echo $city->cityname; ?></td>
                                                            <td class="center">
                                                                <a href="#" class="tblEditBtn" data-id="<?php echo $city->id; ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="#" class="delete tblDelBtn" data-id="<?php echo $city->id; ?>">
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add City
                    </h4>
                ...
                <div class="modal-body">
                    <div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" name="cityname" data-required="1" placeholder="Enter City"
...
<script>
 ...
 // smallModel
    ...
    if (cityname !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/Save_City");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getCityById"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#staticBackdrop [name="cityname"]').val(response.name);
	...
	$(document).on('click','#update',function(){
        ...
        $.ajax({
			type:'post',
			url: '<?php echo base_url("Navigator/update_city");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Navigator/delete_city') ?>',
    data: {id:id},
    success: function (response) {
