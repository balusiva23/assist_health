...
<script>
 ...
 // smallModel
    ...
    if (slot !== '' &&  start_time !== '' && end_time !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/add_time_slot");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getTimeSlotByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
        ...
        event.preventDefault();
         ...
         $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/update_time_slot");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Navigator/delete_time_slot') ?>',
    data: {id:id},
    success: function (response) {
