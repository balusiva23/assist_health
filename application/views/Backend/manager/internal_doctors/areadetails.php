...
<body
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">City Area</div>
                            </div>
                        ...
                        <div class="col-md-12">
                          <div class="d-flex justify-content-end">
                                  <a type="button" data-bs-toggle="modal" data-bs-target="#smallModel" 
                                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary text-right"  style="text-transform: capitalize;">Add Area
								</a>
                           </div>
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center" style="width: 40%;"> City </th>
																	<th class="center" style="width: 40%;"> Area </th>
                                                ...
                                                <?php
                                                 ...
                                                 if (!empty($areadetails)) {
                                                    ...
                                                    foreach ($areadetails as $area) { ?>
                                                        <tr class="odd gradeX" data-id="<?=$area->id;?>">
                                                            
                                                            <td class="center"><?php echo $count; ?></td>
                                                            <td class="center"><?php echo $area->cityname; ?></td> 
															<td class="center"><?php echo $area->areaname; ?></td>
                                                            <td class="center">
                                                                <a href="#" class="tblEditBtn" data-id="<?php echo $area->id; ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="#" class="delete tblDelBtn" data-id="<?php echo $area->id; ?>">
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add Area
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
					<div class="form-group row">
						<label class="control-label col-md-3"> Select City
							<span class="required"> * </span>
						</label>
						<div class="col-md-8">
							<select class="form-control input-height" name="cityid" id="cityid"  required>
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" name="areaname" data-required="1" placeholder="Enter City"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Update Area</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
					<div class="form-group row">
                     ...
                     <div class="form-group row">
						...
						<div class="col-md-8">
							<input type="text" name="areaname" data-required="1" placeholder="Enter area"
...
<script>
 ...
 // smallModel
        ...
        $("#form_sample_add").valid();
		 ...
		 var cityname = $("input[name='cityid']").val();
    ...
    if (cityname !== '' && areaname !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/Save_Areadetails");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getAreadetailsById"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#staticBackdrop [name="cityid"]').val(response.cityid);
					
					$('#staticBackdrop [name="areaname"]').val(response.areaname);
                   $('#staticBackdrop [name="cityid"]').attr("disabled", true);
                     // Open the modal
	...
	$(document).on('click','#update',function(){
        ...
        $.ajax({
			type:'post',
			url: '<?php echo base_url("Navigator/update_areadetails");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Navigator/delete_areadetails') ?>',
    data: {id:id},
    success: function (response) {
