...
<!-- 
                                            ...
                                            <a type="button" href="<?php echo base_url(); ?>Navigator/View_members" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-info" >Back</a>
...
$(document).ready(function() {
 ...
 $(document).on('click','#save_member',function(){
       ...
       //new
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/Book_member_appoinment");?>',
        ...
        position: 'top-right'
         ...
         setTimeout(function(){
        window.location.href = '<?php echo base_url()?>/Navigator/View_Appointments?id='+<?= $user_data->id; ?>;
        },1000);
