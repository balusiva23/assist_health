...
//---------------------------------------------New 29.7.24 --------------------------------
$(document).ready(function() {
    var consultationCount1 = 1;
    var consultationCount2 = 1;

    $('#add_cons_1').click(function() {
        consultationCount1++;
        $('#bar-parent0_1').append(`
            <div id="consultation1-row-${consultationCount1}" class="addfields">
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <label for="simpleFormEmail">Treating Doctor</label>
                            <input type="text" class="form-control" name="treating_doctor[]" placeholder="Enter Doctor's Name">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-1 col-sm-1 mt-4">
                        <button type="button" name="remove" id="consultation1-${consultationCount1}" class="btn btn-danger btn_remove consultation1">X</button>
                    </div>
                </div>
            </div>
        `);
    ...
    $('#add_cons_2').click(function() {
        consultationCount2++;
        $('#bar-parent0_2').append(`
            <div id="consultation2-row-${consultationCount2}" class="addfields">
                <div class="row">
                   <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                                        <label for="simpleFormPassword">Date</label>
                                        <input type="date" class="form-control" name="treatment_date[]" placeholder="Enter  Date" value="<?= ($cons_1->treatment_date) ? date('Y-m-d', strtotime($cons_1->treatment_date)) : '' ?>">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Specialist Details</label>
                                        <input type="text" class="form-control" name="specialist_details[]" placeholder="Enter Specialist Details" >
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group">
                    ...
                    <div class="col-md-1 col-sm-1 mt-4">
                        <button type="button" name="remove" id="consultation2-${consultationCount2}" class="btn btn-danger btn_remove consultation2">X</button>
                    </div>
                </div>
            </div>
        `);
