     ...
     <?php $this->load->view('Backend/manager/manager-temp/header'); ?> 
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Completed Appointments</div>
                            </div>
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center"> Download Invoice</th>
                                                            ...
                                                            ?>
                                                              <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                ...
                                                                <td class="center"><a href="<?php echo base_url('/assets/uploads/completed_invoice/').$member->invoice ?>" download><i
                                                                                style="font-size: 30px;"
                                                                                class="fa fa-cloud-download"></i></a>
                                                                    </td>
                                                                    <td class="center">
                                                                        <a href="edit_patient.html" class="tblEditBtn"
                                                              ...
                                                              <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                ...
                                                                <td class="center"><a href="<?php echo base_url('/assets/uploads/completed_invoice/').$member->invoice ?>" download><i
                                                                    ...
                                                                    <td class="center">
                                                                        <a  class="tblEditBtn1"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#staticBackdrop1" data-id="<?php echo $member->id; ?>">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                        <!-- <a class="tblDelBtn" data-id="<?php echo $member->id; ?>">
                                                                            <i class="fa fa-trash-o"></i>
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
             <form action="#" id="member_compelete_update" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="name" data-required="1"
                                            placeholder="enter first name" value="Rajesh"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            ...
                                            <input class="form-control" type="text" name="appointment_date" id="date" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control input-height" placeholder="Comments"
                                            name="comments" value="add Comments">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-4">Upload Invoice
                                        <span class="required"> </span>
                                    </label>
                                    <div class="col-md-8">
        ...
        <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
             <form action="#" id="member_compelete_update1" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                           ...
                           <!--      <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control input-height" name="payment_status" id="payment_status1">
                                            <option value="">Select...</option>
                                            <option value="Yes">Yes </option>
                                            <option value="No">No</option>
                                        </select>
...
<script type="text/javascript">
        ...
        //$('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getMemberCompletedByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
     ...
     $(document).ready(function() {
       ...
       $(document).on('click','#update',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/update_completed_member_data");?>',
        data: new FormData($("#member_compelete_update")[0]),
        contentType: false,
        processData: false, 
        success:function(resp){
        var data=$.parseJSON(resp);
        if(data.status == 'success'){
        $('#member_compelete_update')[0].reset();
     ...
     // sub profile
       $(document).on('click','#update1',function(){
        event.preventDefault();
           $("#member_compelete_update1").valid();
           if($('#services').val() == 'others'){
            $($('#services')).prop('disabled', true);
       ...
       // if($("#services1").val() != '' && $('#staticBackdrop1 [name="appointment_date"]').val() != '' && $('#staticBackdrop1 [name="appointment_time"]').val() != '' &&  $("#payment_status1").val() != '' ){
        ...
        type:'post',
        url: '<?php echo base_url("Navigator/update_completed_member_data");?>',
        data: new FormData($("#member_compelete_update1")[0]),
        contentType: false,
        processData: false, 
        success:function(resp){
        var data=$.parseJSON(resp);
        if(data.status == 'success'){
        $('#member_compelete_update1')[0].reset();
