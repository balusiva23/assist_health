...
<body>
		...
		<section class="signup">
          ...
          <!--     <div class="form-group">
              ...
              <!--    <div class="input-group-append">
               ...
               <!--  <input type="hidden" id="selected_country_name">

                  <input name="number" id="number" type="number" placeholder="Enter Your  Mobile Number"
                    class="form-control input-height" maxlength="10" required/>
 ...
 <!-- <div class="">You are accepting our <a href="<?php echo base_url(); ?>assets/web_assets/img/tem.pdf" target="_blank">terms and conditions</a> and  <a href="<?php echo base_url(); ?>assets/web_assets/img/privacy.pdf" target="_blank">privacy policy</a> by clicking on 'Register'</div><br>
							-->
              <div class="">
