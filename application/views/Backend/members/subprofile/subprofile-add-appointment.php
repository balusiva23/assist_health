                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Sub Profile Book Appointment</div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Sub Profile Book Appointment</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                   ...
                                   -->
                                            ...
                                            <a type="button" href="<?php echo base_url(); ?>Member/Sub_Profile_Appoinment_list" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-info" >Back</a>
...
$(document).ready(function() {
 ...
 $(document).on('click','#save_member',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Member/Book_member_appoinment");?>',
        ...
        position: 'top-right'
         ...
         setTimeout(function(){
        window.location.href = '<?php echo base_url()?>Member/Sub_Profile_Appoinment_list';
        },1000);
