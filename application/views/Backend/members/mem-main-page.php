                            ...
                            <div class="card card-box  mt-10">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <div class="doctor-profile">
                                        ...
                                        <div class="">
                                      <a type="button" href="<?php echo base_url(); ?>Member/generate_IdCard1?id=<?php echo base64_encode($user_data->id); ?>&m_name=<?php echo base64_encode($user_data->name); ?>&m_id=<?php echo base64_encode($user_data->member_id); ?>" 
                                        class="mdl-button  mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" target="_blank"  style="text-transform: capitalize;">Download ID</a>
                                   </div>
