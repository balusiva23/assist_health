                                                              ...
                                                              //  foreach ($members as $member) {
                                                                 ...
                                                                 <tr class="odd gradeX">
                                                                    ...
                                                                    <td class="center">
                                                                        ...
                                                                        <!-- <a class="btn deepPink btn-outline btn-circle m-b-10"  data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Member/Add_medical_history?id=<?php echo $member->id; ?>">
                                                                            Add/Update Medical History
                                                                        </a>  -->
                                                                        <a class="btn blue-bgcolor btn-outline btn-circle m-b-10"  data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Member/View_medical_history?id=<?php echo $member->id; ?>">
                                                                   ...
                                                                   <!-- <?php if($this->db->where(array('member_id'=>$member->id,'is_active'=>1))->count_all_results('medical_history')) { ?>
                                                                    <?php 
                                                                    $query = $this->db->get_where('medical_history', array('member_id' => $member->id, 'is_active' => 1, 'document =' => NULL));
                                                                    if ($query->num_rows() > 0) { 
                                                                    ?>

                                                                        <?php }else{ 
                                                                            $get_data = $this->db->get_where('medical_history',array('member_id'=>$member->id,'is_active'=>1))->row();
                                                                            ?>
                                                                            <a href="<?php echo base_url()?>assets/uploads/medical_history/<?php echo $get_data->document; ?>" class="tbldownloadbtn" target="_blank" data-id="<?php echo $member->id; ?>">
                                        ...
                                        <input type="text" class="mt-10 form-control" name="medical_conditions" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                  ...
                                                  <input type="text" name="immunizations" class="mt-10 form-control mec4" id="mec4"
                                                        style='display:none;'  />
