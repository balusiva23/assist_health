                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                                            ...
                                            <a type="button" href="<?php echo base_url(); ?>Member/View_Appointments" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-info" >Back</a>
...
$(document).ready(function() {
 ...
 $(document).on('click','#save_member',function(){
        ...
        position: 'top-right'
         ...
         setTimeout(function(){
        window.location.href = '<?php echo base_url()?>/Member/View_Appointments';
        },1000);
