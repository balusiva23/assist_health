...
$(document).ready(function () {
    ...
    function filter_data(page) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>Doctor/fetch_data/" + page,
            method: "POST",
            dataType: "JSON",
            data: {
                action: action,
...
// New--------------------------Filter---------------------------------
 ...
 // $(document).ready(function() {
       ...
       $(document).on('click','.tblEditBtn',function(){
            ...
            $.ajax({
                url: '<?php echo base_url("Doctor/getInternal_DoctorByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
    ...
    //});
        ...
        event.preventDefault();
         ...
         $.ajax({
        type:'post',
        url: '<?php echo base_url("Doctor/Update_internal_doctor");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Doctor/delete_internal_doctor') ?>',
    data: {id:id},
    success: function (response) {
