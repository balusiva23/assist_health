                                                                ...
                                                                foreach ($members as $member) {
                                                                 ...
                                                                 <tr class="odd gradeX">
                                                                    ...
                                                                    <td class="center">
                                                                        ...
                                                                        <a class="btn blue-bgcolor btn-outline btn-circle m-b-10" data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Doctor/View_Appointments?id=<?= 
                                                                        $member->id?>">
                                                                            <!-- <i class="fa fa-eye"></i> -->
                                                                            view
                                                                        </a>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn blue-bgcolor btn-outline btn-circle m-b-10" data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Doctor/Subprofile_View_members?id=<?= 
                                                                        $member->id?>">
                                                                             <!-- <i class="fa fa-eye"></i> -->
                                                                            view
                                                                        </a>
                        ...
                        <form action="#" id="member_form_add" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="password" data-required="1"
                                            class="form-control input-height" />
                                    </div>
                                </div>
