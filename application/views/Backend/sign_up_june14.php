...
<div class="row justify-content-end">
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" id="referral_discount" name="referral_discount" class="form-control input-height custom-field" readonly>
            </div>
        </div>
    </div>
</div>
...
//     let totalAmount = $('.total1').val();//10000; // Initial amount
//         let promoCode = $('#promo_code').val();
//         let referralCode = $('#referal_id').val();
//         let promoDiscount = 0;
//         let referralDiscount = 0;
//         let finalAmount;
//         // Define promo code discount (example: PROMO10 gives 10% discount)
...
//         }
//           finalAmount = totalAmount - referralDiscount;
//         }
...
//             referralDiscount = 100;
//         }
//          finalAmount = totalAmount - promoDiscount - referralDiscount;
//         if(promoDiscount > 0){
...
//         let finalAmount;
//         // Define referral code discount (example: REFERRAL50 gives 50 rupees discount)
//         if (referralCode === 'AAA01') {
//             referralDiscount = 100;
//         }else{
//           //alert("Promo code is invalid")
...
//             promoDiscount = totalAmount * 0.10;
//         }
//         //let finalAmount = totalAmount  - referralDiscount;
//          finalAmount = totalAmount - referralDiscount - promoDiscount ;
...
//      let totalAmount = $('.total1').val();//10000; // Initial amount
//      var memberRow = $(this).closest('.member-container');
//    var member_amount = memberRow.find('.member_amount').val();  // Get the value of member_amount
//       console.log('Removing member with amount:', member_amount);
//       let referralCode = $('#referal_id').val();
//       let promoCode = $('#promo_code').val();
//        let promoDiscount = 0;
...
//        let finalAmount1 = totalAmount - member_amount ;
//        console.log("Member Discount" + finalAmount1);
//        let finalAmount = finalAmount1 - promoDiscount - referralDiscount ;
//        console.log("finalAmount" + finalAmount1);
       
//        $('.total1').val(finalAmount1.toFixed(0));
//        $('.total2').val(finalAmount.toFixed(0));
