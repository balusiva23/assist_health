                        ...
                        <div class="col-md-12">
                            <div class="tabbable-line">
                            	<div class="d-flex justify-content-end">
                                  <a type="button" href="<?php  echo base_url('Admin/Book_Appointment?id=') ?><?=$this->input->get('id');?>" 
    ...
    <script src="<?php echo base_url(); ?>assets/backend_assets/bundles/flatpicker/js/flatpicker.min.js"></script>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            ...
                                            <input class="form-control" type="date" id="appointment_date" name="appointment_date" required><!-- date -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="form-control" type="time" id="" name="appointment_time" required><!-- time -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control input-height" name="payment_status">
      ...
      $('#ongoingtbl').DataTable({
        ...
        //$('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getMemberAppointmentByID"); ?>',
                 method: 'GET',
                data: { id: id },
                dataType: 'json',
