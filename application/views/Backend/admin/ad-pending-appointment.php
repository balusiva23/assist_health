                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"> Pending Appointment</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center" style=" width: "> Address </th>
...
<script type="text/javascript">
      ...
      //  $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getMemberPendingByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
