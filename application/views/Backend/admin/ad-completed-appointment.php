                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"> Completed Appointment</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getMemberCompletedByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
       ...
       //   if($("#services").val() != '' && $("#date").val() != '' && $("#time").val() != '' && $("#payment_status").val() != '' ){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/update_completed_member_data");?>',
