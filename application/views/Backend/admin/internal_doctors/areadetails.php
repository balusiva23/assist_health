...
<script>
 ...
 // smallModel
    ...
    if (cityname !== '' && areaname !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/Save_Areadetails");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getAreadetailsById"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
	...
	$(document).on('click','#update',function(){
        ...
        $.ajax({
			type:'post',
			url: '<?php echo base_url("Admin/update_areadetails");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Admin/delete_areadetails') ?>',
    data: {id:id},
    success: function (response) {
