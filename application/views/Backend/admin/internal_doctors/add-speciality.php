...
<script>
 ...
 // smallModel
    ...
    if (specialityname !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/Save_Speciality");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getSpecialityById"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
	...
	$(document).on('click','#update',function(){
        ...
        $.ajax({
			type:'post',
			url: '<?php echo base_url("Admin/update_speciality");?>',
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Admin/delete_speciality') ?>',
    data: {id:id},
    success: function (response) {
