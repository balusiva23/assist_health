...
<body
                            ...
                            <div class="card card-box">
                              ...
                              <!--       <div class="row">
                                    ...
                                    <input type="hidden" name="member_id" value="<?=$this->input->get('id');?>">
                                        ...
                                        <a type="button" href="<?php echo base_url()?>Admin/Medical_history" class="btn btn-default">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
   ...
   <?php $this->load->view('Backend/admin/admin-temp/footer'); ?> 
    ...
    <?php $this->load->view('Backend/admin/admin-temp/add-more-fields'); ?> 
</body>
...
<script type="text/javascript">
   ...
   $(document).on('click','#add_medical',function(){
       ...
       // {
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/save_medical_history");?>',
        ...
        setTimeout(function(){
        window.location.href = '<?php echo base_url()?>Admin/Medical_history';
        },2000);
       ...
       $.confirm({
        ...
        $.ajax({
        type: 'post',
        url: '<?php echo base_url('Admin/delete_items') ?>',
