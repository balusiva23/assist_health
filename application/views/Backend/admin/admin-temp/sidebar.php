                    ...
                    <div id="remove-scroll" class="left-sidemenu">
                        <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu <?= $this->uri->segment(2) === 'Add_Navigator' || $this->uri->segment(2) === 'All_Navigators' ? 'style="display: block;"' : '' ?>">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url(); ?>Admin/Promocode" class="nav-link "> <span class="title">
                                                Promo Code</span>
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                                ...
                                <ul class="sub-menu"  <?= $this->uri->segment(2) === 'All_Members' || $this->uri->segment(2) === 'Add_Member' || $this->uri->segment(2) === 'SubProfileupgrade' || $this->uri->segment(2) === 'Medical_history' || $this->uri->segment(2) === 'GenerateIDCard'  ? 'style="display: block;"' : '' ?>>
                                    ...
                                    <li class="nav-item <?= $this->uri->segment(2) === 'SubProfileupgrade' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url(); ?>Admin/SubProfileupgrade" class="nav-link "> <span class="title"> Sub Profile Upgrade</span>
                                        </a>
                                    </li>  
                             ...
                             <li class="nav-item  ">
                                ...
                                <ul class="sub-menu " <?= $this->uri->segment(2) === 'Add_InternalDoctor' || $this->uri->segment(2) === 'All_InternalDoctors'|| $this->uri->segment(2) === 'Time_slots' ? 'style="display: block;"' : '' ?>>
                                   ...
                                   <li class="nav-item  <?= $this->uri->segment(2) === 'Add_Speciality' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url(); ?>Admin/Add_Speciality" class="nav-link "> 
                                          <span class="title">Add Speciality
                                            </span>
                                        </a>
                                    </li>
									<li class="nav-item  <?= $this->uri->segment(2) === 'cities' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url(); ?>Admin/cities" class="nav-link "> 
                                          <span class="title">City
                                            </span>
                                        </a>
                                    </li>
									<li class="nav-item  <?= $this->uri->segment(2) === 'cities' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url(); ?>Admin/areadetails" class="nav-link "> 
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu"  <?= $this->uri->segment(2) === 'ViewBlog'  ? 'style="display: block;"' : '' ?>>
                                     ...
                                     <li class="nav-item <?= $this->uri->segment(2) === 'ViewBlog' ? 'active' : '' ?> ">
                                        <a href="<?php echo base_url(); ?>Admin/ViewBlog" class="nav-link "> <span class="title">
                                                Blog
                                                </span>
                                        </a>
                                    </li> 
