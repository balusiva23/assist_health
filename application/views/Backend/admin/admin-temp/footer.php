<div class="page-footer">
  ...
  <?php $this->load->view('Backend/common'); ?> 
    ...
    <script type="text/javascript">
        ...
        // }
        function CheckColors4(val) {
            // Use jQuery to select the input with class 'mec4'
            var element = $('.mec4'); // Selects the input with class 'mec4'

            // Check if the selected value is 'others'
            if (val == 'others') {
                element.show(); // Show the input field
            } else {
                element.hide(); // Hide the input field
            }
        }
