...
<body
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center" style="width: 40%;text-align:center"> Promo Code </th>
                                                                    <th class="center" style="width: 40%;text-align:center"> Percentage(%) </th>
                                             ...
                                             <tbody>
                                                ...
                                                ?>
                                                        <tr class="odd gradeX" data-id="<?=$navigator->id;?>">
                                                            ...
                                                            <td class="center"><?php echo $navigator->promo_code; ?></td>
                                                            <td class="center"><?php echo $navigator->percentage; ?></td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add Promo Code
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group row">
                                <label class="control-label col-md-3"> Promo Code
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-8">
                                    <input type="text" name="promo_code"  id="promo_code" data-required="1" placeholder="Enter Promo Code"
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Update Promo Code</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group row">
...
<script>
 ...
 // smallModel
    ...
    if (slot !== '' &&  start_time !== '' && end_time !== '' ) {
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/add_Promocode");?>',
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getpromo_codeByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#staticBackdrop [name="promo_code"]').val(response.promo_code);
                    $('#staticBackdrop [name="percentage"]').val(response.percentage);
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Admin/delete_Promocode') ?>',
    data: {id:id},
    success: function (response) {
