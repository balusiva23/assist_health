                                ...
                                <div class="card-body" id="bar-parent">
                                    <form  id="member_form_add" method="post" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <a type="button" href="<?php echo base_url(); ?>Admin/View_members" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-info" >Back</a>
...
$(document).ready(function() {
 ...
 $(document).on('click','#save_member',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/Book_member_appoinment");?>',
        ...
        position: 'top-right'
         ...
         setTimeout(function(){
        window.location.href = '<?php echo base_url()?>Admin/View_Appointments?id='+<?= $user_data->id; ?>;
        },1000);
