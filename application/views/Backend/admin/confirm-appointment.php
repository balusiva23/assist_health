...
<body
                                                            ...
                                                            ?>
                                                              <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                ...
                                                                <td class="center">
                                                                  ...
                                                                  <a href="" class="tbldownloadbtn" data-bs-toggle="modal" data-bs-target="#downloadmodal" data-id="<?php echo $member->id; ?>">
                                                            ...
                                                            ?>
                                                              <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                ...
                                                                <td class="center">
                                                                  ...
                                                                  <a href="" class="tbldownloadbtn1" data-bs-toggle="modal" data-bs-target="#downloadmodal1" data-id="<?php echo $member->id; ?>">
                                                                    <i class="fa fa-download"></i>
                                                                  </a>
                                                                </td>
                                                              </tr>
    ...
    <div class="modal fade" id="smallModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="form-control" type="time" id="time" name="appointment_time" required>
         ...
         <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Update Sub Profile Appointment Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                          ...
                          <!--       <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="form-control" type="text" id="date1" name="appointment_date" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="form-control" type="time" id="time1" name="appointment_time" required>
        ...
        <div class="modal fade" id="downloadmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
               <form  id="downloadform" method="post" class="form-horizontal" target="_blank" action="<?php echo base_url("Admin/Appointmentpdf"); ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- Sub profile downlaod -->
    <div class="modal fade" id="downloadmodal1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
               <form  id="downloadform1" method="post" class="form-horizontal" target="_blank" action="<?php echo base_url("Admin/Appointmentpdf"); ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Download Appointment Details</h5>
    ...
    $('#exampletbl').DataTable({
      ...
      //  $('.tblEditBtn').click(function() {
             $('#exampletbl').on('click', '.tblEditBtn', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getMemberOngoingByID"); ?>',
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                ...
                console.log(response.member_id)
                    ...
                    if (optionExists) {
                        ...
                        $('#mec4').hide(); // Hide the 'Others' text field
                    } else {
                        servicesField.val('others');  // Set dropdown to "Others"
                        $('#mec4').val(serviceValue).show();  // Show 'Others' text field and set the value
                    }
   ...
   $(document).ready(function() {
      //  $('.tblEditBtn').click(function() {
       ...
       $(document).on('click','#update',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/update_ongoing_member");?>',
       ...
       // rowToUpdate.find(".center:eq(8)").text(data.member.comments);
        ...
        if($("#services1").val() != '' && $("#date1").val() != '' && $("#time1").val() != '' && $("#payment_status1").val() != '' ){
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/update_ongoing_member");?>',
...
$(document).ready(function() {
      $('#exampletbl').on('click', '.tbldownloadbtn', function() {
        //$('.tblEditBtn').click(function() {
            // Get the data attributes from the button
             var id = $(this).data('id');
            $('#time').removeAttr("readonly");
            ...
            // Make an AJAX request to retrieve the data for the ID
            $.ajax({
                url: '<?php echo base_url("Admin/getMemberOngoingByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
                ...
                $('#downloadmodal [name="member_id"]').val(response.member_id);
                    ...
                    var servicesField = $('#downloadmodal [name="services"]');
                    var serviceValue = response.services;
                    var optionExists = servicesField.find('option[value="' + serviceValue + '"]').length;

                    if (optionExists) {
                        servicesField.val(serviceValue);  // Select the value if it exists in the dropdown
                        $('#downloadmodal #mec4').hide(); // Hide the 'Others' text field
                    } else {
                        servicesField.val('others');  // Set dropdown to "Others"
                        $('#downloadmodal #mec4').val(serviceValue).show();  // Show 'Others' text field and set the value
                    }
...
//sub profile
$(document).ready(function() {
      $('#subexample4').on('click', '.tbldownloadbtn1', function() {
        //$('.tblEditBtn').click(function() {
            // Get the data attributes from the button
             var id = $(this).data('id');
            $('#time1').removeAttr("readonly");
            ...
            $.ajax({
                ...
                $('#downloadmodal1 [name="member_id"]').val(response.member_id);
                $('#downloadmodal1 [name="member_id"]').val(response.member_id);
                    ...
                    var servicesField = $('#downloadmodal1 [name="services"]');
                    var serviceValue = response.services;
                    var optionExists = servicesField.find('option[value="' + serviceValue + '"]').length;

                    if (optionExists) {
                        servicesField.val(serviceValue);  // Select the value if it exists in the dropdown
                        $('#downloadmodal1 #mec4').hide(); // Hide the 'Others' text field
                    } else {
                        servicesField.val('others');  // Set dropdown to "Others"
                        $('#downloadmodal1 #mec4').val(serviceValue).show();  // Show 'Others' text field and set the value
                    }
                    var servicesField = $('#downloadmodal1 [name="services"]');
                    var serviceValue = response.services;
                    var optionExists = servicesField.find('option[value="' + serviceValue + '"]').length;
...
//     $('.mec').change(function() {
//         if ($(this).val() == "others") {
//             $('.mec4').show(); // Show the input for "Others"
//             $(this).prop('disabled', true); // Disable the select
//         } else {
//             $('.mec4').hide(); // Hide the input for "Others"
//             $(this).prop('disabled', false); // Enable the select
//         }
//     });
// });
