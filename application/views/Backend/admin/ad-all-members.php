...
<body
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center" style="width:30% !important;"> Address </th>
                                                                ...
                                                                foreach ($members as $member) {
                                                                 ...
                                                                 <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                    ...
                                                                    <td class="center"><a href="tel:<?=$number; ?>">
                                                                      ...
                                                                      <td class="center">   <?=ucwords($member->membership); ?></td>
                                                            ...
                                                            <a href="#" class="tblEditBtn"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#staticBackdrop123" data-id="<?php echo $member->id; ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Update Health Assessment Record</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="#" id="health_assessment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ah_id" class="form-control" placeholder="AH ID">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="height" class="form-control" placeholder="Height (in cm)">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="speech_language" class="form-control" placeholder="Speech and Language">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="cognitive_function" class="form-control" placeholder="Cognitive Function">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="social_emotional" class="form-control" placeholder="Social and Emotional">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="motor_skills" class="form-control" placeholder="Motor Skills">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="chronic_illness" class="form-control" placeholder="Chronic Illness">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="previous_surgeries" class="form-control" placeholder="Previous Surgeries">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="current_medication" class="form-control" placeholder="Current Medication">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="immunization_record" class="form-control" placeholder="Immunization Record">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="family_medical_history" class="form-control" placeholder="Family Medical History">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="hearing" class="form-control" placeholder="Hearing">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="teeth_condition" class="form-control" placeholder="Teeth Condition">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="dietary_habits" class="form-control" placeholder="Dietary Habits">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="water_intake" class="form-control" placeholder="Water Intake">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="sleep_pattern" class="form-control" placeholder="Sleep Pattern">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="personal_hygiene" class="form-control" placeholder="Personal Hygiene">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="physical_activity" class="form-control" placeholder="Physical Activity">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="text" name="menstrual_health" class="form-control" placeholder="Menstrual Health">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="other_concerns" class="form-control" placeholder="Any Other Concerns">
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="col-lg-12 p-t-20 text-center">
                                <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btn-circle btn-primary">
                                    Update
                                </button>
                            </div>
                        </div>
