                                     ...
                                     <form  id="member_form_add" method="post" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <!-- <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="checkbox" id="stud_checkbox" name="stud_checkbox">
                                                </div>
                                            </div> -->
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control"
                                                                placeholder="Emergency Contact"  autocomplete="off" name="emergency_contact_name">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control"
                                                      ...
                                                      <!--   <div class="col-md-4">
                                                            <input type="text" class="form-control"
                                                             ...
                                                             <input type="text" class="form-control"
                                                                            placeholder="Phone number" autocomplete="off" name="emergency_contact_phone" id="emergency_contact_phone" maxlength="10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <!-- <div class="row mt-10">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control"
                                                                placeholder="Exercise habits" name="exercise_habits" autocomplete="off" >
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" name="diet_preferences" 
                                                                placeholder="Diet preferences or restrictions"
                                                                autocomplete="off" >
                                                        </div>
