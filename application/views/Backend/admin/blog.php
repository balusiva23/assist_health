                                                ...
                                                <?php
                                                 ...
                                                 if (!empty($timeSlots)) {
                                                    ...
                                                    foreach ($timeSlots as $navigator) {
                                                        ...
                                                        // $intro_short = implode(' ', array_slice($intro_words, 0, 5));
                                                        // $intro_remaining = implode(' ', array_slice($intro_words, 5));
                                                         // Ensure the content is properly stripped of any unwanted tags and spaces


                                                    // $intro = strip_tags($navigator->content);
                                                    // $intro_words = explode(' ', $intro);
                                                    
                                                    // // Slice the first 20 words for the short intro
                                                    // $intro_short = implode(' ', array_slice($intro_words, 0, 10));
                                                    
                                                    // // Get the remaining words for the remaining intro
                                                    // $intro_remaining = implode(' ', array_slice($intro_words, 10));


                                                     // Full content with HTML tags intact
                                                ...
                                                ?>
                                                        <tr class="odd gradeX" data-id="<?=$navigator->id;?>">
                                                            ...
                                                            <td class="center"> <img src="<?php echo base_url(); ?>assets/uploads/blog/<?php echo $navigator->thumnail ?>" alt="" class="img-fluid" style="width: 50px;"></td>
                                                                    <!-- <td class="center"style="width: 40%;text-align:justify">         
 ...
 // smallModel
    ...
    //     })
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/getBlog_codeByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
    ...
    var formData = new FormData();
         ...
         $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/add_Blog");?>',//update_Blog
...
//     if (introMore.style.display === 'none' || introMore.style.display === '') {
//         introShort.style.display = 'none';
//         introMore.style.display = 'inline';
//         button.textContent = 'Read Less';
