...
class MYPDF1 extends TCPDF
{
   ...
   public $nav_no = '';
    ...
    public function Header()
    {
        ...
        $html = <<<EOD
        <table cellpadding="5" style="text-align:;">
        <tr>
      
            <td width="21%" style="border-bottom:2px solid black;">
            ...
            <td width="35%" align="" style="border-bottom:2px solid black;">
            <p style="font-weight: bold;">&nbsp;AssistHealth Navigator :</p>
            <p style="font-weight: bold;">&nbsp;Navigator Name : {$this->nav_name}</p>
            <p style="font-weight: bold;">&nbsp;Contact Number : {$this->nav_no}</p>
