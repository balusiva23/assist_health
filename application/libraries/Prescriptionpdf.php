...
class PRESCRIPTIONPDF extends TCPDF
{
    public $id = '';
    //Page header
    public function Header()
    {
        ...
        <tr>
        <td width="4%"></td>
            <td width="30%" style="border-bottom:2px solid black;">
                <img src="$image_file" width="100px" height="80px" align="center"/>
            </td> 
            <td width="33%" align="center" style="border-bottom:2px solid black;">
            ...
            <p style="font-size:15px;font-weight:bold"><a href="https://www.assisthealth.in/" >www.assisthealth.in</a></p>
             ...
             <td style="background-color: ;color:black;  vertical-align: bottom;border-bottom:2px solid black;" width="30%" align="center">
            <p></p>
            <p></p>
            <p></p>
...
//  <h4>AssistHealth ID : {$this->id}</h4>
    ...
    public function Footer() {
        ...
        $this->SetFont('helvetica', 'I', 12);
            ...
            // Add Dr. Vasu G R's details above the footer line
        $this->SetX(10);
        $this->MultiCell(0, 5, "Dr. Vasu G R\nConsultant Orthopaedic Surgeon\nAssistHealth Clinic, Sahakar Nagar, Bangalore - 560092\nKMC REG NUM: 51006", 0, 'L', false, 1, '', '', true);
        $this->Ln(3);
