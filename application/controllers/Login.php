...
class Login extends CI_Controller {
	...
	{
        $this->load->view('Backend/New_Signup'); //sign_up
       
		//$this->load->view('Backend/sign_up1'); //Actual
	}
    //New
	...
	// 	$this->load->view('Backend/sign_up'); //sign_up
	// }
...
/*                text-align: center;*/
    ...
    <body style="background-color: ">
        ...
        if ($inquiryMail->send() && $thankYouMail->send()) {
            //echo json_encode(array('status' => 'success', 'message' => 'Register Successfully!!'));
            echo json_encode(array('status' => 'success', 'message' => 'Thank you for contacting us!'));

            // Set session variable to indicate the form has been submitted
  ...
  public function subcribe_mail1() {
...
public function enquiry() {
    ...
    $number = $this->input->post('enquiry-number');
    $message = $this->input->post('enquiry-message');
    $service = $this->input->post('enquiry-service');
          ...
          <table>
              ...
              <tr>
                  <td><strong>service</strong></td>
                    <td><?php if(isset($service)) { echo  $service; } ?></td>
              </tr> 
               <tr>
                  <td><strong>Message</strong></td>
                    <td><?php if(isset($message)) { echo  $message; } ?></td>
...
/*                text-align: center;*/
   ...
   /*Forget*/
    ...
    public function check_referral() {
        ...
        $this->db->where('member_id', $referral_id);
...
public function enquiry_package() {
    $name = $this->input->post('package-name');
    $email = $this->input->post('package-email');
    $number = $this->input->post('package-number');
    $message = $this->input->post('package-message');
    $package = $this->input->post('pac');
          ...
          <table>
              ...
              <tr>
                  <td><strong>Package</strong></td>
                    <td><?php if(isset($package)) { echo  $package; } ?></td>
              </tr> 
               <tr>
                  <td><strong>Message</strong></td>
                    <td><?php if(isset($message)) { echo  $message; } ?></td>
