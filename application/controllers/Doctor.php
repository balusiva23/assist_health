  ...
  $this->load->view('Backend/admin/IdCard/memberID',$data);
   ...
   public function Add_InternalDoctor()
   {
	...
	// Retrieve all time slots directly in the controller
	   ...
	   $this->load->view('Backend/doctor/internal_doctors/add-internal-doctor',$data);
   }
   ...
   public function All_InternalDoctors()
   {
	   ...
	   $this->load->view('Backend/doctor/internal_doctors/all-internal-doctors',$data);
   }
	   ...
	   function fetch_data()
	   {
		...
		// Time_slots 22/1/24
		   public function Time_slots()
		   {
			   ...
			   $this->load->view('Backend/doctor/internal_doctors/time-slots',$data);
		   }
...
public function ViewBlog()
{
	...
	$this->load->view('Backend/doctor/blog',$data);
}
...
public function getBlog_codeByID() {
 ...
 public function SubProfileupgrade(){
   ...
   $data['allmembers'] = $this->Manager_model->getAllMembers();
   $this->load->view('Backend/doctor/subprofile-upgrade',$data);
 }
...
public function delete_docu() {
  ...
  if ($success) {
	  ...
	  public function PreMembers()
	{
		...
		$data['allmembers'] = $this->Doctor_model->getdoctorMembers($id);
		$this->load->view('Backend/doctor/pre-members',$data);
	}
	public function save_prescription_data()
{
    if ($this->session->userdata('user_login_access') != False) {
        // Get input data from form
        $id = $this->input->post('id'); // If ID is present, it will be an update, else it's an add
        $member_id = $this->input->post('member_id'); // If ID is present, it will be an update, else it's an add
        $m_id = $this->input->post('m_id'); // If ID is present, it will be an update, else it's an add
        $name = $this->input->post('name');
        ...
        $isActive = $this->input->post('isActive') ?? 1;  // Default to 1 if not provided
		$date = date('d-M-y');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // Check if an ID is provided (update case) or not (add case)
            if ($id) {
                ...
                $success = $this->Manager_model->updatePrescription($data, $id);
                
                if ($success) {
                    echo json_encode(array('status' => 'success', 'message' => 'Prescription data updated successfully', 'prescription' => $data));
                } else {
                    echo json_encode(array('status' => 'error', 'message' => 'Failed to update prescription data'));
                }
            } else {
				// Prepare data array for insertion or update
				$data = array(
                ...
                // Add a new record if no ID
                $success = $this->Manager_model->insertPrescription($data);

                if ($success) {
                    echo json_encode(array('status' => 'success', 'message' => 'Prescription data added successfully', 'prescription' => $data));
                } else {
                    echo json_encode(array('status' => 'error', 'message' => 'Failed to add prescription data'));
                }
            }
        }
    } else {
	...
	public function save_prescription_data1()
{
    if ($this->session->userdata('user_login_access') != False) {
        // Get input data from form
        $id = $this->input->post('id'); // If ID is present, it will be an update, else it's an add
        ...
        $investigations = $this->input->post('investigations');
        $note = $this->input->post('note');
        $parent_member_id = $this->input->post('parent_member');
        $member_status = $this->input->post('member_status');
        $isActive = $this->input->post('isActive') ?? 1;  // Default to 1 if not provided
		$date = date('d-M-y');
...
public function Get_prescription_data(){
	...
	$getdata = $this->Manager_model->Get_prescription_data($id);
	if($getdata){
	$i = 1;
	foreach($getdata as $value){
	echo' <tr>
		...
		<td scope="row">'.$value->Chief_Complaints.'</td>
		<td scope="row"><a href="'. base_url().'Doctor/Prescriptionpdf?id='.$value->id.'" class=""  target="_blank">
                                                                                <i class="fa fa-file"></i>
                                                                        </a>
	<a href="#" class="edit_btn"  data-id="'.$value->id.'">
                                                                    <i class="fa fa-pencil"></i>
                                                                  </a>
</td>
...
//<td><a title="Delete" class=" deleteImage" data-id="'.$value->id.'">   <i class="bi bi-trash-fill"></i></a></td>
   ...
   public function getPrescriptionByID() {
	// Get the ID parameter from the AJAX request
	$id = $this->input->get('id');//echo $id;
	$member = $this->Manager_model->getprescription($id);
...
$response = array(
    ...
    'Gender' => $member->Gender,
    'Address' => $member->Address,
    'Chief_Complaints' => $member->Chief_Complaints,
    'Allergies' => $member->Allergies,
    'History' => $member->History,
    'Diagnosis' => $member->Diagnosis,
    'Treatment' => $member->Treatment,
    'Investigations' => $member->Investigations,
    'Note' => $member->Note,
  ...
  public function Prescriptionpdf()
  {
	...
	$id = $this->input->get('id');//getprescription
	$getdata = $this->Manager_model->getprescription($id);
	...
	//  $pdf->setPrintFooter(false);
	  ...
	  $mem_id = ($getdata->m_id) ? "AssistHealth ID :". $getdata->m_id : "";
...
<table>
  ...
  <tr>
    ...
    <td style="width:20%;font-size:14px; text-transform: capitalize;">: $getdata->Name</td>
...
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;"> : $getdata->Age years</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Gender</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Address</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Chief_Complaints</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Allergies</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->History</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">:  $getdata->Diagnosis</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Treatment</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Investigations</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: $getdata->Note</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
