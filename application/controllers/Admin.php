...
// pdf
  ...
  //ID card
	...
	public function cities()
	{
		...
		$cities = $this->Doctor_model->getAll_City();
        $data['cities'] = $cities;		
	    $this->load->view('Backend/admin/internal_doctors/cities',$data);
	}
	public function areadetails()
	{
	    ...
	    $this->load->view('Backend/admin/internal_doctors/areadetails',$data);
	}
	...
	public function Add_Speciality()
	{
		...
		$specialities = $this->Doctor_model->getAll_Speciality();
        $data['specialities'] = $specialities;		
	    $this->load->view('Backend/admin/internal_doctors/add-speciality',$data);
	}
	...
	public function Update_internal_doctor()
	  ...
	  //update modal get data
       ...
       //assets\backend_assets\img\id
		$img_file = base_url().'assets/backend_assets/img/id/id-bg.png';//bg1.jpg

		$pdf->Image($img_file, 10, 10, 150, 80, '', '', '', false, 300, '', false, false, 0);
		  $pdf->SetMargins(10, 10, 10, 0);
		// HTML content
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-right:5%">
		    <tr>
		    <br>
		    <td style="width: 48%; "><p style="font-weight: bold; color: #38B6FF;"> <br><br> <br>
		        <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="background-color: ; border-radius: 10px;  margin-left: 10px; width:10%"><span style="color:#38B6FF;text-transform: uppercase;">'.$m_name.'</span></span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: black;background-color: ;border-radius: 10px;  ">ASSISTHEALTH ID:&nbsp;&nbsp;<span style="color: #aa893f;background-color: ;">'.$m_id.'</span></span> </p>
...
public function add_medical_history_document()
{
  ...
  // ------------------------------ Time slots  END ---------------------------------------------------- //
		 ...
		 public function Promocode()
		 {
			 ...
			 $this->load->view('Backend/admin/promo_code',$data);
		 }
		 ...
		 public function add_Promocode() {
			 // Handle form submission to add a new time slot
			 $promo_code = strtolower($this->input->post('promo_code'));
			 $percentage = $this->input->post('percentage');
			

			 // Check if a time slot with the same slot already exists with isActive set to 1
			 $this->db->where('LOWER(promo_code)', $promo_code);
			 $this->db->where('isActive', 1);
			 $existingSlot = $this->db->get('promocode')->row();
			 ...
			 $this->db->where('isActive', 1);
			 $existingTimeSlot = $this->db->get('promocode')->row();

			 if ($existingTimeSlot) {
				 // Time slot with the same start_time and end_time already exists, return an error
				 echo json_encode(array('status' => 'error', 'message' => 'Code  already exists '));
				 return;
			 }
			 ...
			 $success = $this->db->insert('promocode', $data);
			 ...
			 // Update data in the "time_slots" table
			 $this->db->where('id', $id);
			 $success =   $this->db->update('promocode', $data);
		 ...
		 public function delete_Promocode() {
			 ...
			 $this->db->where('id', $id);
			 $success =   $this->db->delete('promocode');
		 ...
		 public function getpromo_codeByID() {
			 // Get the ID parameter from the AJAX request
			 $id = $this->input->get('id');
			 ...
			 $response = array(
				 'id' => $timeSlot->id,
				 'promo_code' => $timeSlot->promo_code,
		...
		//    print_r($_POST);
		 ...
		 public function getBlog_codeByID() {
		  ...
		  public function SubProfileupgrade(){
			...
			$data['members'] = $this->Manager_model->getAllMemberslist();
			$data['allmembers'] = $this->Manager_model->getAllMembers();
			$this->load->view('Backend/admin/subprofile-upgrade',$data);
		  }
  ...
  public function Prescriptionpdf()
  {
	  ...
	  $this->load->library('PRESCRIPTIONPDF');

	  $pdf = new PRESCRIPTIONPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'utf-8', false);
...
<table>
  ...
  <tr>
    ...
    <td style="width:20%;font-size:14px; text-transform: capitalize;">: Mrs</td>
    <td style="width:10%;">Date </td>
	<td style="width:20%;font-size:14px; text-transform: capitalize;">: 20.12.2024</td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Age </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;"> : 41 years</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Sex </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: Male</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    ...
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: L & T Raintree Boulevard, Bangalore</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Chief Complaints </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: Pain in the Right Ankle while playing Sports Yesterday</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Allergies </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: </td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">History </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: Twisting injury while playing cricket</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Diagnosis </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: Sprained Ankle</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Treatment </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: </td>
    <td style="width:10%;"></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Investigations </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: X Ray B/L Ankle AP And Oblique</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
<table>
  ...
  <tr>
    <td style="width:10%;"></td>
    <td style="width:30%;font-size:12px;">Note </td>
    <td style="width:50%;font-size:14px; text-transform: capitalize;">: To review after X Ray</td>
    <td style="width:10%;"></td>
  </tr>
</table>
<br><br>
...
EOD;
  ...
  public function AssessmentPDF()
  {
	  ...
	  $this->load->library('AssessmentPDF');

	  $pdf = new AssessmentPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'utf-8', false);

	  $pdf->SetCreator(PDF_CREATOR);
	  $pdf->SetAuthor('Health Assessment');
	  $pdf->SetTitle('Health Assessment');
	  $pdf->SetSubject('Health Assessment');
	  //$pdf->SetKeywords('TCPDF, PDF, example, test, codeigniter');
	  ...
	  // set font
	  // $pdf->SetFont('times', 'BI', 12);
	  $pdf->SetMargins(0, 20, 0); // Left, Top, Right margins in mm
...
$txt = <<<EOD
 <br><br><br><br><br>
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Student Information</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
</table>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:13%;font-size:12px;">Student Name:</td>
        <td style="width:32%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:8%;font-size:12px;">AH ID:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Date of Birth:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Grade:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Parent Name:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Contact No:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
</table>
...
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Vital Signs</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Height:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Weight:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">BMI:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Blood Pressure:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Pulse Rate:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Temperature:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
</table>
...
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Developmental Assessment</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Speech and Language:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Cognitive Function:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Social and Emotional:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Fine and Gross Motor Skills:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
</table>
...
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Medical History</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Allergies:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Chronic Illness:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Previous Surgeries:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Current Medication:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Immunization Record:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Family Medical History:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
</table>
...
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Nutrition and Hygiene</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Dietary Habits:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Water Intake:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Sleep Pattern:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Personal Hygiene:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Physical Activity:</td>
        <td style="width:35%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
        <td style="width:4%;"></td>
        <td style="width:10%;font-size:12px;">Menstrual Health:</td>
        <td style="width:33%;font-size:14px; text-transform: capitalize;border-bottom:2px dashed black;"></td>
    </tr>
</table>
<br><br>
...
<table cellpadding="5" style="text-align:center; width: 100%; border-spacing: 0; vertical-align: middle;">
    <tr>
        <td width="4%"></td>
        <td width="30%" style="text-align:center; background-color: #09689C; padding: 10px;"></td>
        <td width="33%" align="center" style="background-color: #09689C; padding: 10px; vertical-align: middle;"><h4 style="margin: 0; color: white; vertical-align: middle;">Additional Comments</h4>
        </td>
        <td width="30%" align="center" style="background-color: #09689C; color: black; vertical-align: bottom; padding: 10px;"></td>
        <td width="4%"></td>
    </tr>
...
<table>
    <tr>
        <td style="width:4%;"></td>
        <td style="width:40%;">If Any Other Concern :</td>
        <td style="width:50%;font-size:12px; text-transform: capitalize;border-bottom:2px dashed black;" colspan="5"></td>
		 <td width="4%"></td>
    </tr>
</table>
